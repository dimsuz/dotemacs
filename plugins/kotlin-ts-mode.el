...
(define-derived-mode kotlin-ts-mode prog-mode "Kotlin"
  ...
  (when (treesit-ready-p 'kotlin)
    ...
    ;; Navigation (added by @dimsuz)
    (setq-local treesit-defun-type-regexp "\\(function_declaration\\|class_declaration\\)")
